...
@Component({
  ...
  styles: [`
    .boards-screen { min-height: 100%; background: var(--mm-bg, #F3F1ED); position: relative; display: flex; flex-direction: column; }
    ...
    .boards-subtitle { font-size: 14px; color: var(--mm-label-secondary, #6E6E6E); padding: 0 16px 16px; }
    ...
    .board-row { display: flex; align-items: center; gap: 12px; padding: 14px 16px; border-bottom: 0.5px solid var(--mm-sep-faint, rgba(0,0,0,0.06)); cursor: pointer; }
    ...
    .board-unread-badge { position: absolute; top: -4px; right: -4px; width: 16px; height: 16px; border-radius: 50%; background: var(--mm-gold, #C9A961); color: #fff; font-size: 10px; font-weight: 700; display: flex; align-items: center; justify-content: center; }
    .board-row-info { flex: 1; min-width: 0; }
    .board-row-name { font-size: 16px; font-weight: 600; color: var(--mm-label, #1A1A1A); }
    .board-row-meta { font-size: 13px; color: var(--mm-label-secondary, #6E6E6E); margin-top: 1px; }
    .board-row-desc { font-size: 13px; color: var(--mm-label-secondary, #6E6E6E); line-height: 1.4; margin-top: 2px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }

    /* ── Thread view ─────────────────────────────────────── */
    .thread-topbar { display: flex; align-items: center; padding: 10px 16px; border-bottom: 0.5px solid var(--mm-sep, rgba(0,0,0,0.08)); background: var(--mm-bg, #F3F1ED); }
    .back-btn { background: none; border: none; cursor: pointer; display: flex; align-items: center; gap: 4px; font-size: 16px; font-weight: 500; color: var(--mm-label, #1A1A1A); padding: 4px 0; }
    ...
    .board-header-name { font-size: 18px; font-weight: 700; color: var(--mm-label, #1A1A1A); }
    .board-header-sub { font-size: 13px; color: var(--mm-label-secondary, #6E6E6E); margin-top: 2px; }
    .posts-list { display: flex; flex-direction: column; }
    .post-item { display: flex; gap: 10px; padding: 12px 16px; border-bottom: 0.5px solid var(--mm-sep-faint, rgba(0,0,0,0.06)); cursor: pointer; }
    ...
    .post-item-author { font-size: 15px; font-weight: 600; color: var(--mm-label, #1A1A1A); }
    .post-item-meta { font-size: 12px; color: var(--mm-label-secondary, #6E6E6E); margin-top: 1px; }
    .post-item-content { font-size: 14px; color: var(--mm-label, #1A1A1A); margin-top: 4px; line-height: 1.4; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; }
    .post-item-actions { display: flex; align-items: center; gap: 4px; margin-top: 8px; }
    .post-action-btn { width: 32px; height: 32px; border: none; background: none; cursor: pointer; display: flex; align-items: center; justify-content: center; border-radius: 50%; color: var(--mm-label-secondary, #6E6E6E); }
    .post-action-btn:hover { background: rgba(0,0,0,0.05); }
    .posts-empty { padding: 48px 24px; text-align: center; color: var(--mm-label-secondary, #6E6E6E); font-size: 14px; }
    ...
    .detail-author { font-size: 15px; font-weight: 600; color: var(--mm-label, #1A1A1A); }
    .detail-meta { font-size: 12px; color: var(--mm-label-secondary, #6E6E6E); margin-top: 1px; }
    .risk-badge { font-size: 12px; font-weight: 600; padding: 3px 10px; border-radius: 22px; flex-shrink: 0; background: var(--mm-bg-chip, #E6E4DE); color: var(--mm-label, #1A1A1A); }
    .risk-badge.high { background: rgba(224,66,107,0.15); color: #E0426B; }
    .risk-badge.med { background: rgba(201,169,97,0.2); color: #B08D3F; }
    .detail-body { font-size: 15px; line-height: 1.5; color: var(--mm-label, #1A1A1A); margin: 0 0 16px; }
    ...
    .publish-btn { padding: 9px 16px; border: none; border-radius: 22px; background: var(--mm-bg-chip, #E6E4DE); color: var(--mm-label, #1A1A1A); font-size: 14px; font-weight: 600; cursor: pointer; margin-left: auto; }
    .detail-section { margin-bottom: 16px; }
    .section-label { font-size: 11px; font-weight: 700; color: var(--mm-label-secondary, #6E6E6E); letter-spacing: 0.3px; text-transform: uppercase; margin-bottom: 8px; }
    .history-row { font-size: 13px; color: var(--mm-label-secondary, #6E6E6E); padding: 4px 0; }
    .comment-row { display: flex; gap: 10px; padding: 8px 0; border-bottom: 0.5px solid var(--mm-sep-faint, rgba(0,0,0,0.06)); }
    .comment-author { font-size: 14px; font-weight: 600; color: var(--mm-label, #1A1A1A); }
    .comment-text { font-size: 14px; color: var(--mm-label, #1A1A1A); margin-top: 2px; line-height: 1.4; }
    .comment-body { flex: 1; min-width: 0; }

    /* ── Inline sticky reply composer ────────────────────── */
    .reply-composer-sticky { padding: 12px 16px; border-top: 0.5px solid var(--mm-sep, rgba(0,0,0,0.08)); background: var(--mm-bg, #F3F1ED); }
    .reply-composer-card { border: 0.5px solid var(--mm-sep, rgba(0,0,0,0.08)); border-radius: 12px; padding: 10px 12px; background: #fff; }
    .reply-textarea { width: 100%; border: none; outline: none; background: transparent; font-size: 15px; line-height: 1.4; color: var(--mm-label, #1A1A1A); resize: none; font-family: inherit; box-sizing: border-box; min-height: 32px; }
    ...
    .reply-send-btn { width: 32px; height: 32px; border-radius: 50%; background: var(--mm-label, #1A1A1A); border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; }
    ...
    .compose-full-head { display: flex; align-items: center; padding: 14px 16px; border-bottom: 0.5px solid var(--mm-sep, rgba(0,0,0,0.08)); }
    ...
    .compose-counter { flex: 1; text-align: center; font-size: 17px; font-weight: 600; color: var(--mm-label-secondary, #6E6E6E); }
    .compose-counter.over-limit { color: var(--mm-heart, #E0426B); }
    .compose-send-btn { width: 36px; height: 36px; border-radius: 12px; background: var(--mm-label, #1A1A1A); border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; }
    ...
    .compose-full-textarea { flex: 1; border: none; outline: none; background: transparent; font-size: 17px; line-height: 1.4; color: var(--mm-label, #1A1A1A); resize: none; font-family: inherit; min-height: 120px; width: 100%; padding-right: 90px; box-sizing: border-box; }
    .compose-audience-wrap { position: absolute; right: 16px; top: 50%; transform: translateY(-50%); }
    .audience-select { appearance: none; -webkit-appearance: none; border: 0.5px solid var(--mm-sep, rgba(0,0,0,0.08)); border-radius: 22px; padding: 11px 22px; font-size: 15px; font-weight: 600; color: var(--mm-label, #1A1A1A); background: var(--mm-bg-chip, #E6E4DE); cursor: pointer; }
    .compose-board-row { padding: 0 16px 8px; display: flex; align-items: center; gap: 8px; }
    .board-select { flex: 1; border: none; background: transparent; font-size: 14px; color: var(--mm-label-secondary, #6E6E6E); outline: none; }
    .compose-attachment-row { display: flex; align-items: center; gap: 22px; padding: 14px 16px; border-top: 0.5px solid var(--mm-sep, rgba(0,0,0,0.08)); }
    .attach-btn { border: none; background: none; cursor: pointer; display: flex; align-items: center; justify-content: center; padding: 0; }
    .lang-chip { font-size: 11px; font-weight: 700; padding: 4px 8px; border-radius: 6px; background: var(--mm-bg-chip, #E6E4DE); color: var(--mm-label-secondary, #6E6E6E); }
  `],
  template: `
    <div class="boards-screen" data-testid="feed-page">
      ...
      <ng-container *ngIf="viewState === 'index'">
        ...
        <div class="boards-list">
          <div *ngFor="let board of boards"
            ...
            <mm-pill-btn *ngIf="isBoardJoined(board.slug)" kind="ghost"
              (onClick)="$event.stopPropagation(); leaveBoard(board.slug)">Leave</mm-pill-btn>
            <mm-pill-btn *ngIf="!isBoardJoined(board.slug)" kind="default"
              (onClick)="$event.stopPropagation(); joinBoard(board.slug)">Join</mm-pill-btn>
          </div>
        </div>
      ...
      <ng-container *ngIf="viewState === 'thread' && !selectedPost">
        ...
        <div class="board-header-card" *ngIf="selectedBoardSummary as board">
          ...
          <mm-pill-btn *ngIf="!isBoardJoined(board.slug)" kind="dark"
            (onClick)="joinBoard(board.slug)">Join</mm-pill-btn>
          <mm-pill-btn *ngIf="isBoardJoined(board.slug)" kind="ghost"
            (onClick)="leaveBoard(board.slug)">Leave</mm-pill-btn>
        </div>
            ...
            <form (ngSubmit)="addComment(selected.id)" data-testid="feed-comment-form">
              ...
              <div class="reply-actions">
                <button type="button" class="reply-attach-btn" aria-label="Attach image">
                  <m-icon name="image" [size]="18" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
                </button>
                <button type="button" class="reply-attach-btn" aria-label="Attach GIF">
                  <m-icon name="gif" [size]="18" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
                </button>
        ...
        <div class="compose-full-modal" (click)="$event.stopPropagation()">
          <form [formGroup]="form" (ngSubmit)="createPost()" class="compose-full-form" data-testid="create-post-form">
            ...
            <div class="compose-board-row">
              <m-icon name="hash" [size]="16" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
            ...
            <div class="compose-attachment-row">
              <button type="button" class="attach-btn" aria-label="Image">
                <m-icon name="image" [size]="22" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
              </button>
              <button type="button" class="attach-btn" aria-label="GIF">
                <m-icon name="gif" [size]="22" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
              </button>
              <button type="button" class="attach-btn" aria-label="Poll">
                <m-icon name="chart" [size]="22" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
              </button>
              <button type="button" class="attach-btn" aria-label="Content warning">
                <m-icon name="warning" [size]="22" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
              </button>
              <span class="lang-chip">EN</span>
              <div style="flex:1"></div>
              <button type="button" class="attach-btn" aria-label="More options">
                <m-icon name="dots" [size]="22" color="var(--mm-label-secondary, #6E6E6E)"></m-icon>
              </button>
            </div>
